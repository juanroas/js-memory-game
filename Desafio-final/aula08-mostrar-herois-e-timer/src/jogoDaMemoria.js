class JogoDaMemoria {
  ...
  // vai ignorar o resto das propiedades e pegar somente a propriedade
  // tela
  ...
  exibirHerois(nomeDoHeroi) {
    const { img } = this.heroiIniciais.find(({ nome }) => nomeDoHeroi === nome);
  ...
  mostrarHeroisEscondidos() {
    ...
    for (const heroi of heroisEscondidos) {
      const { img } = this.heroiIniciais.find(item => item.nome === heroi.nome)
      heroi.img = img
    }
